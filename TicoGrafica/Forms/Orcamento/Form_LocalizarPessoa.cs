...
namespace TicoGrafica.Forms.Forms.Orcamento
{
    public partial class Form_LocalizarPessoa : Form
    {
        ...
        public Form_LocalizarPessoa(IServiceScopeFactory scopeFactory, Form_Cadastrar_Orcamento form_Cadastrar_Orcamento)
        {
        ...
        public Form_LocalizarPessoa(IServiceScopeFactory scopeFactory, Form_Alterar_Orcamento form_Alterar_Orcamento)
        {
            _scopeFactory = scopeFactory;
        ...
        private void SelecionarPessoa()
        {
            ...
            {
                _form_Cadastrar_Orcamento.SetarPessoa(idPessoa);
                this.Dispose();
            }
            else if (_form_Alterar_Orcamento != null)
            {
                _form_Alterar_Orcamento.SetarPessoa(idPessoa);
                this.Dispose();
            }
        }
